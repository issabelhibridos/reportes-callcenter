    ...
    return (
        <section className='my-20'>
            ...
            <div className="grid mb-8 rounded-lg border border-gray-200 shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
                <figure className="flex flex-col justify-center items-center p-8 text-center bg-defaultbg rounded-t-lg border-b border-gray-200 md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="mx-auto mb-4 max-w-2xl text-gray-700 lg:mb-8 dark:text-gray-400">
                    ...
                    <figcaption className="flex justify-center items-center space-x-3">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left">
                            ...
                            <div className="text-sm font-light text-gray-700 dark:text-gray-400">Developer at Random AI</div>
                        </div>
                    </figcaption>
                </figure>
                <figure className="flex flex-col justify-center items-center p-8 text-center bg-defaultbg rounded-tr-lg border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="mx-auto mb-4 max-w-2xl text-gray-700 lg:mb-8 dark:text-gray-400">
                    ...
                    <figcaption className="flex justify-center items-center space-x-3">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left">
                            ...
                            <div className="text-sm font-light text-gray-700 dark:text-gray-400">Lead designer at Random</div>
                        </div>
                    </figcaption>
                </figure>
                <figure className="flex flex-col justify-center items-center p-8 text-center bg-defaultbg rounded-bl-lg border-b border-gray-200 md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="mx-auto mb-4 max-w-2xl text-gray-700 lg:mb-8 dark:text-gray-400">
                    ...
                    <figcaption className="flex justify-center items-center space-x-3">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left">
                            <div>Jese Leos</div>
                            <div className="text-sm font-light text-gray-700 dark:text-gray-400">Software Engineer at Random</div>
                        </div>
                    </figcaption>
                </figure>
                <figure className="flex flex-col justify-center items-center p-8 text-center bg-defaultbg rounded-b-lg border-gray-200 md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="mx-auto mb-4 max-w-2xl text-gray-700 lg:mb-8 dark:text-gray-400">
                    ...
                    <figcaption className="flex justify-center items-center space-x-3">
                        ...
                        <div className="space-y-0.5 font-medium dark:text-white text-left">
                            ...
                            <div className="text-sm font-light text-gray-700 dark:text-gray-400">CTO at Random</div>
                        </div>
                    </figcaption>
                </figure>
            </div>
